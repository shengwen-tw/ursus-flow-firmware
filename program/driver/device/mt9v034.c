...
static void mt9v034_context_config(void)
{
	...
	mt9v034_write_half_word(
	        ...
	        (MT9V034_WINDOW_WIDTH_MAX - CALIB_IMG_HEIGHT * IMAGE_BINNING) / 2 + MT9V034_COLUMN_START_MIN
	);
	mt9v034_write_half_word(
	        MT9V034_ROW_START_B,
	        (MT9V034_WINDOW_HEIGHT_MAX - CALIB_IMG_WIDTH * IMAGE_BINNING) / 2 + MT9V034_ROW_START_MIN
	);
